...
def default_argument_parser():
    ...
    parser.add_argument(
        "--dataset-name",
        default="ade20k_sem_seg_val",  # "kvasir_seg_sem_seg_val",
        choices=["ade20k_sem_seg_val", "coco_2017_test_stuff_10k_sem_seg",
                 "ade20k_full_sem_seg_val", "kvasir_seg_sem_seg_val"],
