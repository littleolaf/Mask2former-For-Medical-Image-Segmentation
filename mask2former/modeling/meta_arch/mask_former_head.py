...
class MaskFormerHead(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            num_classes: number of classes to predict (133)
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        return {
            "input_shape": {  # 定义一个字典，键为输入形状的特征键，值为输入形状的特征值
    ...
    def layers(self, features, mask=None):
        ...
        if self.transformer_in_feature == "multi_scale_pixel_decoder":
            predictions = self.predictor(multi_scale_features, mask_features, mask)  # mask2former used，最后的mask参数没用上
        else:
